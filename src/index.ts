...
export class OneNoteMCPServer extends MCPServer {
  ...
  constructor() {
    ...
    this.registerFunctionGroup(new NotebookManagement(this.credential));
    this.registerFunctionGroup(new SectionManagement(this.credential));
    this.registerFunctionGroup(new PageManagement(this.credential));
  }
}
